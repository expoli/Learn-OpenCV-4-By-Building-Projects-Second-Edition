...
int main(int argc, const char **argv) {
    ...
    switch (sample) {
        ...
        case 2: {
            ...
            // 基本乘法运算
        case 3: {
            cout << "Sample 3, Mat operations:" << endl;
        ...
        default: {
            cout << "Input error! Please input int 0-6" << endl;
            return -1;
        }
    }
